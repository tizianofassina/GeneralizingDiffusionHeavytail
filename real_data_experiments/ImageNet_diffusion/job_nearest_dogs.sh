...
# ============================================================================
# Slurm script for nearest-neighbor qualitative analysis on the dogs dataset.
#
...
echo "Directory: $(pwd)"
echo "Starting nearest-neighbors qualitative analysis (dogs)..."

# ── Execution ───────────────────────────────────────────────────────────────
python -u nearest_for_plot_dogs.py