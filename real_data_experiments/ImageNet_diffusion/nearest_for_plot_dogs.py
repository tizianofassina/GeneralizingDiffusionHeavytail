...
all_dog_labels = [int(v) for k, v in class_map_config["class_map_dogs"].items()]
n_to_plot = 10
random.seed(0)
LABELS_TO_CHECK = random.sample(all_dog_labels, n_to_plot)  # [160, 258, 251, 239, 157]
NUM_QUERIES_PER_CLASS = 10
BATCH_SIZE_DECODE = 16
SAVE_BASE_DIR = "photos_IN_dogs_for_plot"  # This changes from 300 to dogs

DATASETS_TO_SEARCH = {  # This changes from 300 to dogs
    "real_train": "../NoisedFlow/ImageNet_Flow/datasets/train_set_tensor_IN_dogs_normalized.pt",
    "edm_classic": "generation/init_&_gen/generation_edm_classic_seed_0.pt",
    "flow_cfg_1.5": "generation/init_&_gen/generation_flow_IN_CFG_1.5_sigma_7_factor_14_big_128_seed_0.pt",
    "flow_cfg_0.5_dynamical": "generation/init_&_gen/generation_flow_IN_CFG_0.5_sigma_7_factor_14_big_128_dynamical_seed_0.pt",
    "gaussian_sigma_7": "generation/init_&_gen/generation_gaussian_sigma_7_seed_0.pt",
    "empirical": "generation/init_&_gen/generation_empirical_seed_0.pt",
}
