...
#SBATCH --job-name=metrics_dogs_h100
...
# ============================================================================
# Slurm script for computing evaluation metrics on the dogs dataset (H100).
#
...
echo "Launching metrics computation on H100 (dogs)..."

# ── Execution ───────────────────────────────────────────────────────────────
python -u compute_results_dogs.py